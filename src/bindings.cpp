...
PYBIND11_MODULE(trossen_vr, m) {
    ...
    py::class_<trossen_vr::NetworkManager>(m, "NetworkManager",
        ...
        .def("latest_frame", &trossen_vr::NetworkManager::latest_frame,
            ...
            ":returns: Latest VR frame, or None if none available\n"
            ":rtype: VRFrame or None")
        ...
        .def("get_message_frequency", &trossen_vr::NetworkManager::get_message_frequency,
            ...
            ":returns: Frequency in Hz, or 0.0 if no messages received yet\n"
            ":rtype: float");
    ...
    py::class_<trossen_vr::Teleop>(m, "Teleop",
        ...
        "Analog inputs fire on every dispatch() call; poses fire on every\n"
        "dispatch() call when the controller is tracked.\n\n"
        ...
        .def("on_button_a", &trossen_vr::Teleop::on_button_a,
            ...
            ":param handler: Callback function with no arguments")
        ...
        .def("on_right_trigger", &trossen_vr::Teleop::on_right_trigger,
            ...
            ":param handler: Callback function receiving float value 0.0-1.0")
        ...
        .def("on_right_pose", &trossen_vr::Teleop::on_right_pose,
            ...
            ":param handler: Callback function receiving Pose6D")
    ...
    m.def("pose6d_to_transform4d", &trossen_vr::pose6d_to_transform4d,
        ...
        ":param pose6d: Pose6D with position and axis-angle rotation\n"
    ...
    m.def("transform4d_to_pose6d", &trossen_vr::transform4d_to_pose6d,
        ...
        ":param transform4d: Transform4D (4x4 matrix)\n"
        ":returns: 6D pose with position and axis-angle rotation\n"
        ":rtype: Pose6D");
}
